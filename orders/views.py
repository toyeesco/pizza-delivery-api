...
class OrderDetailView(generics.GenericAPIView):
    ...
    @swagger_auto_schema(operation_description="Updating ann order by id")
    ...
    @swagger_auto_schema(operation_description="Remove/delete an order")
...
class UserOrderDetail(generics.GenericAPIView):
    ...
    @swagger_auto_schema(operation_description="Get a user's specific order")
